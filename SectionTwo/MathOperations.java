public class MathOperations {
  public static void main(String[] args) {
    ...
    long startsInMilkyWay = 2500000000L;
    ...
    System.out.println("There are " + (starsInAndromeda + startsInMilkyWay) + "stars in the Milky Way and Andromeda galaxies.");
    ...
    System.out.println("The Andromeda Galaxy has " + (starsInAndromeda - startsInMilkyWay) + " more stars than the Milky Way");
    ...
    System.out.println("Andromeda has " + (starsInAndromeda / startsInMilkyWay) + " times more stars");
